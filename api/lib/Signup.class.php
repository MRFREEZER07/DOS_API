...
class Signup
{
    ...
    public function sendVerificationMail()
    {
        ...
        $mail->Body    = "<strong>plz verify your account . by clicking on this link    <a herf =\"https://karthik.selfmade.lol/verify?token=$token\">clicking here:)</a> or open it manually https://karthik.selfmade.lol/verify?token=$token <strong> ";
